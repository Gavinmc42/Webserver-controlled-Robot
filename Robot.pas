...
uses
  ...
  WebControl,     {Add our LED page unit for our custom HTTPDocument class}
  ParamsPage,
  hardware;  {And add the params page unit so we can see the parameters passed to the server}

var 
 IPAddress:String;
 WindowHandle:TWindowHandle;
 HTTPListener:THTTPListener;
 RobotPage:TRobotPage;
...
begin
 ...
 RobotPage:=TRobotPage.Create;
 
 {And register our LED page with the HTTP listener}
 HTTPListener.RegisterDocument('',RobotPage);
 ...
 ConsoleWindowWriteLn(WindowHandle,'Ready, point your browser to http://' + Winsock2TCPClient.LocalAddress + '/Robot');
